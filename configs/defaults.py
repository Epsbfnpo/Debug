...
_C.OUT_DIR = "/datasets/work/hb-nhmrc-dhcp/work/liu275/DGDR/Fusion_20260428/output_esdg_h100"
_C.USE_CUDA = True
_C.SEED = 42
_C.num_workers = 8
_C.VERBOSE = True
...
_C.GDRNET.CONS_PROJ_DIM = 1024
_C.GDRNET.LAMBDA_CONS = 0.2
_C.GDRNET.CONS_WARMUP_EPOCHS = 10
