...
_C.GDRNET.LAMBDA_ORTHO = 0.1
_C.GDRNET.LAMBDA_SPMIX = 1.0
_C.GDRNET.LAMBDA_FEAT_ALIGN = 1.0
_C.GDRNET.LAMBDA_LOGIT_KD = 1.0
_C.GDRNET.LAMBDA_DINO_CLS = 0.5
_C.GDRNET.LAMBDA_GLOBAL = 1.0

_C.GDRNET.LAMBDA_SUP = 1.0
_C.GDRNET.LAMBDA_MASKED = 1.0
_C.GDRNET.LAMBDA_SIAM = 1.0
