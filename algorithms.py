...
class CASS_GDRNet(Algorithm):
    ...
    def update(self, minibatch):
        ...
        x_cnn_input = F.interpolate(img_strong, size=(448, 448), mode='bilinear', align_corners=False)
        x_vit_input = F.interpolate(img_strong, size=(768, 768), mode='bilinear', align_corners=False)
